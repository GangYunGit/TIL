...
- CSS는 상속을 통해 부모 요소의 속성을 자식에게 상속한다.
  ...
  - 상속이 되지 않는 것 : Box model 관련 요소(widt, height, margin, padding, border, box-sizing, display), position 관련 요소(position, topa/right/bottom/left, z-index) 등
